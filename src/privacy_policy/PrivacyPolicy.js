		...
		<div className="privacy-screen">
			<div className="privacy_policy">
				...
				<PrivacyPolicySections
					header="Contact support at"
					subheader="tahirnasri96@gmail.com"
				/>
				<PrivacyPolicySections
					header="PRIVACY NOTICE"
					subheader="Last updated April 18, 2021"
					notes={privacyNotice}
				/>
				<PrivacyPolicySections
